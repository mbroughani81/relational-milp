...
python3 -m benchmarks.run_crown \
  ...
  --csv fixing-binary-vars-experiment/crown-2-512-3pixel-kfsb.csv
...
python3 -m benchmarks.run_crown \
  ...
  --suite-options timeout=60 \
  --suite-options limit=100 \
  --csv fixing-binary-vars-experiment/crown-3-100-3pixel-kfsb.csv
...
python3 -m benchmarks.run_crown \
  ...
  --suite-options timeout=60 \
  --suite-options limit=100 \
  --csv fixing-binary-vars-experiment/crown-3-100-global-kfsb.csv
...
python3 -m benchmarks.run_crown \
  ...
  --suite-options timeout=60 \
  --suite-options limit=100 \
  --csv fixing-binary-vars-experiment/crown-4-1024-3pixel-kfsb.csv
